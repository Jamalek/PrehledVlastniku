...
public class GUI extends JFrame{
	...
	private void initialize() throws IOException {
		...
		setTitle("Vyberte soubor pro vytvoření přehledu");
		...
		UIManager.put("FileChooser.cancelButtonText", "Zavřít");
		UIManager.put("FileChooser.cancelButtonToolTipText", "Zavře okno a ukončí program");
		...
		UIManager.put("FileChooser.newFolderErrorText", "Chyba ve vytvoření složky");
		...
		UIManager.put("FileChooser.upFolderToolTipText", "Do adresáře o úroveň výš");
		...
		textPane.setText("Program vytvořil Jan Málek. E-mail: 2janmalek@gmail.com\nAktuální verzi naleznete na adrese: prehledvlastniku.xf.cz");
